...
(() => {
    ...
    let stopReq = false;
    let report = null;
    // ②ファズが「反応の面」へどこまで届いたかの帳簿と、そのための題材（v1497・下の注記）
    let rxLedger = null;
    let rxSamples = null;
     ...
     */
    // mix=3（v1497）… `summon` に「**相手を並べる組**」の枝が入った版。
    ...
    /* ===== ★★ ファズを「反応の面」へ届かせる（v1497・DESIGN_review_pack2.md §4-3／発注書 B） =====
     *
    ...
    /* ★ **回帰テスト（tests.js）から「ライブラリとして」読み込むための口**（v1497）。
     *
