...
class Game {
    ...
    drawReshapePreview(bond) {
        ...
        // ⚠ **飾りに入力を受けさせない**（v1410）。この 7px の帯は結合の真上に描かれるので、
    ...
    renderBond(x1, y1, x2, y2, type, isHConnection = false, bondObj = null, isHaworthFront = false) {
        ...
        if (!isHConnection && bondObj) {
            ...
            hitLine.addEventListener('pointerdown', (e) => {
                ...
                // あちらに足すこと（見出しの透過と同じ一覧から引くための約束。v1410）
                //
                ...
                // と答えてしまい、選んだ直後に C=C が C≡C へ化けた（v1410 の実測で発覚）。
                // 押した時の判断を最後まで持ち回る
            ...
            hitLine.addEventListener('click', (e) => {
                ...
                // （2-ブテンの中点タップで C=C → C≡C。v1410 以前の実測）
