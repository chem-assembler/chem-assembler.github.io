...
class Game {
    constructor() {
        ...
        // ★ 「立体が分かれる場所」の印モード（DESIGN_stereo_point.md 段1・v1434）。
    ...
    handleMouseDown(e) {
        ...
        // --- 「立体が分かれる場所」の印モード (ON) 時の特別処理（v1434・段1） ---
    ...
    tapHasOtherMeaning() {
        ...
        // ★ 「立体が分かれる場所」の印モード（v1434・段1）。**結合をタップして印を付ける**ので、
    ...
    setPracticeStrip(spec) {
        ...
        acts.innerHTML = '';
        // ★ 帯に**書かせる**欄を置けるようにした（v1434・段2「立体異性体も含めた総数」）。
