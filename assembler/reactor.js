...
const REACTION_RULES = [
    ...
    },
    {
        ...
        apply(game, site) {
            ...
            // ★ -OH が C=O になった酸素も「変わった原子」＝ 印に入れる（vNNNN・CV4）
            let oxidizedO = null;
            if (!wasCarbonyl) {
    ...
    },
    {
        ...
        apply(game, site) {
            ...
            /* ★★ **中央へ移った二重結合の両端（C2・C3）にも印を付ける**（vNNNN・CV4）。
    ...
    },
    {
        ...
        apply(game, site) {
            ...
            return {
                 ...
                 * ⚠ vNNNN まで相方（`ca2`・`cb2`）が落ちていた —— 同じ「多重結合を1本減らす」
    ...
    },
    {
        ...
        apply(game, site) {
            ...
            chain.groups.forEach(g => {
                ...
                /* ⚠ 印は**結合が変わった原子だけ**（vNNNN・CV4）。`cA`・`cB` は -OH を
