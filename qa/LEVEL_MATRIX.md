...
Lv の分布: Lv1 243件・Lv2 602件・Lv3 37件・Lv4 14件
...
### sec-states-of-matter（熱運動と物質の三態・6件）
...
### sec-temperature-pressure（物質の三態と状態変化・気体の圧力・13件）

| コード | 群 | 現在 | 教科書 | 教科書→Lv | セミナー | セミナー→Lv | 入試 | 入試→Lv | 目安 §3-2 | 目安 §7-2 | 上書き | 最終 |
|---|---|--:|---|---|---|---|---|---|--:|---|---|--:|
| `theo.state.absolute-temperature` | 温度と圧力・状態図 | 1 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 1 | 1〜2 |  | 1 |
| `theo.state.heating-curve` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.phase-diagram` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.gas-pressure` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.pressure-units` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.speed-distribution` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.pressure-conversion` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.mercury-density` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.phase-enthalpy-def` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.vaporization-larger` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.heating-calc` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.phase-diagram-curves` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `theo.state.ice-pressure-mp` | 温度と圧力・状態図 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
...
| `theo.state.piston-balance` | 気体の法則 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
...
### sec-organic-features（有機化合物の特徴・7件）
...
### sec-hydrocarbon-classes（炭化水素の分類と官能基・15件）
...
| `org.ali.fg-def` | 官能基 | 1 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 1 | 1〜2 |  | 1 |
| `org.ali.fg-structures` | 官能基 | 1 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 1 | 1〜2 |  | 1 |
| `org.ali.fg-oh-neighbor` | 官能基 | 1 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 1 | 1〜2 |  | 1 |
| `org.ali.fg-nitro-sulfo` | 官能基 | 2 | 本文 | ≤3 | 未登場 | — | ①未 ②0 |  | 2 | 1〜2 |  | 2 |
| `org.ali.unsaturation` | 分類・一般式 | 2 | 発展欄 | ≥2 | 基本 | ≤2 | ①0 ②44→84 |  | 2 | 1〜2 |  | 2 |
| `org.ali.suffix` | 分類・一般式 | 2 | 見あたらない（弱） | — | 未登場 | — | ①未 ②0 |  | 2 | 1〜4 |  | 2 |

### sec-organic-formulas（有機化合物の表し方・6件）
...
生成元: `qa/questions.json`（896件）・`qa/data/level_matrix.jsonl` の override 欄・`qa/data/exam_usage.jsonl`・セミナーの材料（リポジトリの外） ／ 生成器: `qa/tools/gen_level_matrix.js`
