...
| `org.bio.isoelectric-point` | アミノ酸 | 1 | 本文（弱） | — | プロセス＋基本 | 1 | ①未 ②10→16 |  | 1 | 1 |  | 1 |
...
生成元: `qa/questions.json`（317件）・`qa/data/level_matrix.jsonl` の override 欄・`qa/data/exam_usage.jsonl`・セミナーの材料（リポジトリの外） ／ 生成器: `qa/tools/gen_level_matrix.js`
