...
Lv の分布: Lv1 103件・Lv2 174件・Lv3 31件・Lv4 10件
...
生成元: `qa/questions.json`（318件）・`qa/data/level_matrix.jsonl` の override 欄・`qa/data/exam_usage.jsonl`・セミナーの材料（リポジトリの外） ／ 生成器: `qa/tools/gen_level_matrix.js`
