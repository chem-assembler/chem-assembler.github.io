...
**両性元素の4つ（Al・Zn・Sn・Pb）は「ああすんなり（あ・あ・すん・なり）」で覚えましょう。**高校化学では、1族・2族以外の典型金属元素はすべて両性元素と考えて問題ありません。
...
//要確認: 化学新研究2015・総合的研究化学 H₂O を酸性酸化物に入れるか（スライド練習１の解答は入れている、教科書は入れないと注記）
