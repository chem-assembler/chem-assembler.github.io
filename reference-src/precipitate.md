...
- 中（Zn〜Ni） | Zn²⁺・Fe²⁺・Mn²⁺ | 沈殿しない | ZnS（白）・FeS（黒）・MnS（淡桃）
- 小（Sn 以下） | Cu²⁺・Pb²⁺・Ag⁺・Cd²⁺・Sn²⁺ | CuS（黒）・PbS（黒）・Ag₂S（黒）・CdS（黄）・SnS（褐） | 沈殿する
:::

**硫化物は「黒が基本」で、例外の色（ZnS 白・CdS 黄・MnS 淡桃・SnS 褐）を覚えます。**そして「酸性でも沈むのは Sn 以下のイオン化傾向の小さい金属」「Zn・Fe は中性・塩基性でだけ沈む」の線引きを覚えてください。この線引きが、系統分離で硫化水素を2回に分けて通す理由になります。
...
//要確認: 化学新研究2015・総合的研究化学 MnS の色の呼び方（スライドは淡桃、教科書は淡赤）。本文はスライドに合わせた
