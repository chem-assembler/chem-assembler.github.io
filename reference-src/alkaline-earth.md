...
天然で見つかる硫酸カルシウムは、水和水を2つもつ CaSO₄・2H₂O の形で、これが**セッコウ**です。セッコウを約 140℃ に加熱すると水和水の一部を失って、半水和物の**焼きセッコウ** CaSO₄・½H₂O になります。焼きセッコウを水で練ると、体積をやや増しながらセッコウにもどって固まるので、建材やセッコウ像に使われます。
