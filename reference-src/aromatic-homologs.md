...
source:
  - qa:芳香族炭化水素/同族体・誘導体
  - stages:toluene・o-xylene・m-xylene・p-xylene・styrene・naphthalene
...
**「側鎖はどんなに長くても、環に付いている根もとの炭素1個だけが残って −COOH になる」と覚えましょう。**エチルベンゼン C₆H₅CH₂CH₃ を酸化しても、できるのはトルエンと同じ安息香酸です。
